        ...
        child: Container(
          ...
          child: Row(
            children: [
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: hasMap ? const Color(0xFFEAF2FF) : const Color(0xFFF3F4F6),
                          ...
                          child: Text(
                            ...
                            style: (textTheme.bodySmall ?? const TextStyle()).copyWith(
                              ...
                              color: hasMap ? AppColors.brandPrimary : Colors.black54,
                            ),
                          ),
                        ),
                      ],
              ...
              const SizedBox(width: AppSpacing.sm),
              const Icon(Icons.arrow_back_ios_new, size: 16, color: Colors.black38),
            ],
          ),
        ),
      ),
